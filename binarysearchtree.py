...
Original file is located at
    https://colab.research.google.com/drive/12R5KI22cjjG8ibqqrDP7Gm6lLSfMuvRS
"""
...
class BinarySearchTreeNode:
    ...
    def delete(self, val):
        if val < self.data:
            ...
            # approach: find min from rst and replacing with it and removing duplicate
            min_val = self.right.find_min()
            self.data = min_val
            self.right = self.right.delete(min_val)
            # approach: find max from lst and replacing with it and removing duplicate
